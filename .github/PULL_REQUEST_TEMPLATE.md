<!-- Thanks for contributing an on-device AI app! -->

## What is this?

<!-- One or two lines. What does the app do, and who would use it? -->
...
<!-- Drop a GIF or screenshot of it running on a physical device. This is required. -->

## Model

- Model: <!-- e.g. Qwen3-4B -->
- Melange page: <!-- https://mlange.zetic.ai/p/... -->

## Notes for reviewers

<!-- Anything tricky? Device tested on? Known limitations? -->
