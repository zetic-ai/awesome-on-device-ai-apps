...
**An AI keyboard that rewrites, replies, translates, and fixes grammar, all on-device. No text ever leaves the phone.**

<p align="center"><img src="../../res/screenshots/ai-keyboard.gif" width="240" alt="CherryPad demo"></p>

Runs entirely on the phone via `LFM2.5-350M`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`LFM2.5-350M`](https://mlange.zetic.ai/p/Steve/LFM2.5_350M) | Android, iOS | [Melange](https://mlange.zetic.ai) |
