...
Runs entirely on the phone via `YOLOv8s (VisDrone)`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`YOLOv8s (VisDrone)`](https://mlange.zetic.ai/p/ajayshah/AerialDetectYOLO) | iOS, Android, Flutter | [Melange](https://mlange.zetic.ai) |
