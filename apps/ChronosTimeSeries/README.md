...
**Probabilistic time-series forecasting with CSV import & interactive charts**

<p align="center"><img src="../../res/screenshots/chronos-recording-ios.gif" width="240" alt="Chronos Forecast demo"></p>

Runs entirely on the phone via `Chronos-Bolt`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`Chronos-Bolt`](https://mlange.zetic.ai/p/Team_ZETIC/Chronos-balt-tiny) | Android, iOS | [Melange](https://mlange.zetic.ai) |
