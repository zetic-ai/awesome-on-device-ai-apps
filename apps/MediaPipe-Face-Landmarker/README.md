...
Runs entirely on the phone via `MediaPipe`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`MediaPipe`](https://mlange.zetic.ai/p/google/MediaPipe-Face-Landmark) | Android, iOS | [Melange](https://mlange.zetic.ai) |
