...
**Reads a sentence aloud and scores your pronunciation per word and per phoneme, fully offline.**

Runs entirely on the phone via `Citrinet-256 (phoneme CTC)`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`Citrinet-256 (phoneme CTC)`](https://mlange.zetic.ai/p/ajayshah/PronunciationScoring) | iOS, Android, Flutter | [Melange](https://mlange.zetic.ai) |
