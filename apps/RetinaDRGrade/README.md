...
**Grades diabetic-retinopathy severity from a fundus photo, on-device (non-diagnostic).**

Runs entirely on the phone via `MobileNetV2`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`MobileNetV2`](https://mlange.zetic.ai/p/ajayshah/RetinaDRGrade) | iOS, Android, Flutter | [Melange](https://mlange.zetic.ai) |
