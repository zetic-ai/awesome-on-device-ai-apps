...
Runs entirely on the phone via `YOLOv8s (PPE)`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`YOLOv8s (PPE)`](https://mlange.zetic.ai/p/ajayshah/SafetyPPEYOLO) | iOS, Android, Flutter | [Melange](https://mlange.zetic.ai) |
