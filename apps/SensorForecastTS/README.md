...
Runs entirely on the phone via `Chronos-Bolt-tiny`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`Chronos-Bolt-tiny`](https://mlange.zetic.ai/p/ajayshah/SensorForecastTS) | iOS, Android, Flutter | [Melange](https://mlange.zetic.ai) |
