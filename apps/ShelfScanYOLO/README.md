...
**Counts and boxes every product facing on a dense retail-shelf photo, on-device.**

Runs entirely on the phone via `YOLO11s (SKU-110K)`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
