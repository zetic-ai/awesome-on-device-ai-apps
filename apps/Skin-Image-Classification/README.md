...
**On-device skin-lesion classification with severity-aware guidance (non-diagnostic)**

<p align="center"><img src="../../res/screenshots/skin-classification.gif" width="240" alt="Skin Classifier demo"></p>

Runs entirely on the phone via `Skin-Cancer ViT`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`Skin-Cancer ViT`](https://mlange.zetic.ai/p/realtonypark/Skin_Cancer-Image_Classification) | Android, iOS | [Melange](https://mlange.zetic.ai) |
