...
**Auto-detects & masks PII (names, emails, phones) before any data moves**

Runs entirely on the phone via `tanaos-anonymizer-v1`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`tanaos-anonymizer-v1`](https://mlange.zetic.ai/p/Steve/text-anonymizer-v1) | Android, iOS | [Melange](https://mlange.zetic.ai) |
