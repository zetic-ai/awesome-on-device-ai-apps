...
///
/// The engine is fully reset between runs so recording works repeatedly.
final class AudioRecorder: ObservableObject {
    ...
    private func start() {
        ...
        // .playAndRecord (not .record) so a sample clip played through the speaker
        // during recording is audible and the mic can pick it up; .record would
        // silence playback. Force the speaker route since .measurement mode can
        // otherwise default output to the receiver.
