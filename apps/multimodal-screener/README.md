...
**Fuses live face- and voice-emotion into an explainable mood check-in**

<p align="center"><img src="../../res/screenshots/screener.gif" width="240" alt="Wellbeing Screener demo"></p>

Runs entirely on the phone via `wav2vec2 · Emo-AffectNet`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`wav2vec2 · Emo-AffectNet`](https://mlange.zetic.ai/p/realtonypark/Wav2Vec2-Base_Emotion-Recognition) | Android, iOS | [Melange](https://mlange.zetic.ai) |
