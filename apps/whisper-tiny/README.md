...
**High-accuracy speech-to-text, fully offline**

Runs entirely on the phone via `Whisper Tiny`, powered by [Melange](https://mlange.zetic.ai). No cloud, no data leaving the device.
...
| :-- | :-- | :-- |
| [`Whisper Tiny`](https://mlange.zetic.ai/p/OpenAI/whisper-tiny-decoder) | Android, iOS | [Melange](https://mlange.zetic.ai) |
